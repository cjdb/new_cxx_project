...
The copied_okay community works to be welcoming and kind among itself and to others,
...
This code of conduct applies to all spaces managed by the copied_okay project. This
...
violating the code of conduct, please report it to the copied_okay leads.
...
-   **When we disagree, we try to understand why.** Disagreements, both social
    and technical, happen all the time, and copied_okay is no exception. It is
...
No weapons are allowed at copied_okay events. Weapons include, but are not limited
...
If you have questions, please feel free to contact a copied_okay lead directly.
...
If you believe someone is violating the code of conduct, you can report it to a copied_okay
lead, by contacting them directly.

**All reports will be kept confidential**, and are only used by the conduct team
to address conduct issues and keep the copied_okay community safe and inclusive.
...
copied_okay leads. The copied_okay leads may choose to make a public statement about the
...
appealed. To appeal a decision of the conduct team, contact the copied_okay
...
If a complaint is raised against a member of the conduct team or copied_okay leads,
...
1.  **Temporary ban**
    ...
    -   **Action:** In addition to the warning action, a temporary ban from use
        of copied_okay's community spaces for a specified period of time. External
...
1.  **Permanent ban**
    -   **Behavior:** Demonstrating a pattern of violation of the code of
        conduct.
    -   **Action:** A permanent ban from use of copied_okay's community spaces.
