...
The default_options community works to be welcoming and kind among itself and to others,
...
This code of conduct applies to all spaces managed by the default_options project. This
...
violating the code of conduct, please report it to the default_options leads.
...
-   **When we disagree, we try to understand why.** Disagreements, both social
    and technical, happen all the time, and default_options is no exception. It is
...
No weapons are allowed at default_options events. Weapons include, but are not limited
...
If you have questions, please feel free to contact a default_options lead directly.
...
If you believe someone is violating the code of conduct, you can report it to a default_options
lead, by contacting them directly.

**All reports will be kept confidential**, and are only used by the conduct team
to address conduct issues and keep the default_options community safe and inclusive.
...
default_options leads. The default_options leads may choose to make a public statement about the
...
appealed. To appeal a decision of the conduct team, contact the default_options
...
If a complaint is raised against a member of the conduct team or default_options leads,
...
1.  **Temporary ban**
    ...
    -   **Action:** In addition to the warning action, a temporary ban from use
        of default_options's community spaces for a specified period of time. External
...
1.  **Permanent ban**
    -   **Behavior:** Demonstrating a pattern of violation of the code of
        conduct.
    -   **Action:** A permanent ban from use of default_options's community spaces.
